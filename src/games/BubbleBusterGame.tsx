...
export const BubbleBusterGame: React.FC<GameComponentProps> = ({
  ...
  return (
    <div
      ...
      className="relative w-full h-full min-h-[440px] flex flex-col items-center justify-center bg-[#050508] select-none overflow-hidden touch-none cursor-crosshair"
    >
      {/* Top HUD */}
