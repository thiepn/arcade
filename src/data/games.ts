...
export const GAMES_REGISTRY: GameEntry[] = [
  ...
  },
  {
    ...
    description: 'Defend the perimeter through four escalating typing waves with progressively longer, denser, faster word sets.',
    category: 'Typing',
    sessionLength: '1–3 min',
    accentColor: '#06b6d4',
    accentGlow: 'rgba(6, 182, 212, 0.4)',
    accentBg: 'rgba(6, 182, 212, 0.1)',
    instructions: 'Type falling words accurately; four escalating typing waves steadily increase vocabulary length and pressure.',
