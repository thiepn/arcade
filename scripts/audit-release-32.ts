...
const requiredQualityGates = [
  ...
  'quality:gameplay-p16','quality:gameplay-p17','quality:gameplay-p18','quality:gameplay-p19','quality:gameplay-p20','quality:gameplay-p21',
  'quality:browser-p3','quality:browser-p17','quality:browser-p18','quality:browser-p19','quality:browser-p20','quality:browser-p21',
  'quality:lifecycle','quality:mobile','quality:rope','quality:rope-feedback','quality:rope-phase-c','quality:blockdrop',
  'quality:knife','quality:puck','quality:rail','quality:release32','quality:hardening',
] as const;
...
const requiredAuditFiles = [
  ...
  'scripts/audit-gameplay-p21.ts','scripts/audit-browser-gameplay-p3.mjs','scripts/audit-browser-gameplay-p17.mjs',
  'scripts/audit-browser-gameplay-p18.mjs','scripts/audit-browser-gameplay-p19.mjs','scripts/audit-browser-gameplay-p20.mjs',
  'scripts/audit-browser-gameplay-p21.mjs','scripts/audit-game-lifecycle.ts','scripts/audit-mobile-runtime.ts',
  'scripts/audit-laser-rope-presentation.ts','scripts/audit-laser-rope-feedback.ts','scripts/audit-laser-rope-phase-c.ts',
  'scripts/audit-block-drop-hold.ts','scripts/audit-knife-target-aim.ts','scripts/audit-air-hockey-layout.ts',
  'scripts/audit-neon-rail-shift.ts','scripts/audit-repository-hardening.ts',
];
...
for (const path of [
  'docs/P17_GAME_FEEL_CERTIFICATION.md','src/lib/gameFeelRuntime.ts','src/lib/gameFeelProfiles.ts','src/p17-game-feel.css',
  'docs/P18_CLARITY_ACCESSIBILITY_CERTIFICATION.md','docs/P18_TERMINOLOGY_REGISTRY.md','src/lib/gameClarityRuntime.ts',
  'src/lib/gameClarityProfiles.ts','src/p18-clarity-accessibility.css','docs/P19_ARCADE_COHESION_CERTIFICATION.md',
  'src/lib/arcadeCohesionRuntime.ts','src/p19-arcade-cohesion.css','docs/P20_NEAR_S_PROMOTION_CERTIFICATION.md',
  'scripts/p20-promotion-scorecards.ts','src/lib/bladeWavePhrases.ts','docs/P21_STRONG_A_PROMOTION_CERTIFICATION.md',
  'scripts/p21-promotion-scorecards.ts',
]) assert(existsSync(join(root, path)), `required permanent release artifact missing: ${path}`);
